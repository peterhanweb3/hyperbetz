...
export default async function PostsPage({ searchParams }: { searchParams: Promise<{ page?: string; search?: string }> }) {
                            ...
                            <TableRow key={post.id}>
                                <TableCell className="font-medium">
                                    <div className="flex flex-col gap-1">
                                        <span className="truncate max-w-[250px] sm:max-w-[350px] font-semibold">{post.title}</span>
                                ...
                                <TableCell className="hidden md:table-cell">{post.author.username}</TableCell>
                                ...
                                <TableCell colSpan={5} className="text-center py-12">
                                    <div className="flex flex-col items-center justify-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">Get started by creating your first post</p>
                                        </div>
                                    </div>
                                </TableCell>
                            </TableRow>
