...
export const metadata = {
    title: 'Blog | HyperBetz - Strategies, Tips & Platform Updates',
    description: 'Discover expert betting strategies, platform updates, and winning tips from the HyperBetz team. Stay ahead of the game with our latest insights.',
}
